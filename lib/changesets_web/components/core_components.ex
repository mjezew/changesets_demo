defmodule ChangesetsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChangesetsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChangesetsWeb.Gettext, "errors", msg, opts)
    end
  end
